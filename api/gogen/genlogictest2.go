...
var logicTestTemplate2 string

func genLogicTest2(dir, rootPkg string, cfg *config.Config, api *spec.ApiSpec) error {
...
func genLogicByRouteTest(dir, rootPkg string, cfg *config.Config, group spec.Group, route spec.Route) error {
	...
	return genFile(fileGenConfig{
		...
		templateName:    "logicTestTemplate2",
		category:        category,
		templateFile:    logicTestTemplate2,
		builtinTemplate: logicTestTemplate2,
		data: map[string]any{
