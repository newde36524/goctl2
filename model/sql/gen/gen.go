...
import (
	...
	"github.com/newde36524/goctl2/model/sql/parser"
	"github.com/newde36524/goctl2/model/sql/template"
	modelutil "github.com/newde36524/goctl2/model/sql/util"
...
func (g *defaultGenerator) executeModelTest(table Table) (*bytes.Buffer, error) {
	...
	output, err := t.Execute(map[string]any{
		...
		"projectName":           getGoModModuleName(g.dir),
		"feilds":                feildsStr,
...
func getGoModModuleName(base string) string {
	for i := 0; i < 10; i++ {
