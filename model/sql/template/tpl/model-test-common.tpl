...
// OptimisticLock 乐观锁
func OptimisticLock[T any](ctx context.Context, session sqlx.Session, tableName string, id int64, fn func(ctx context.Context, session sqlx.Session, in *T) error) error {
	data, err := Get[T](ctx, session, squirrel.Select().From(tableName).
